...
const Edit = ({ detailData, loadingRolesUser, errorFetchingRolesUser, rolesUser, fetchData, visible, onHide, fetchdataDearah, fetchdataDesa, fetchDataKelompok }) => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      const response = await fetchClient().post('/api/user/update', values);
          ...
          {({ errors, touched, isSubmitting }) => (
            <Form>
              <div className="p-2 m-2">
                <h4 className="fw-semibold">Ubah User</h4>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="row p-1 m-1">
                  <Field showClear filter as={Dropdown} id="role_daerah" name="role_daerah" options={fetchdataDearah} className={errors.role_daerah && touched.role_daerah ? 'p-invalid' : ''} optionLabel="label" optionValue="value" placeholder="Pilih salah satu" />
                </div>
              ...
              <div className="mb-3">
                ...
                <div className="row p-1 m-1">
                  <Field showClear filter as={Dropdown} id="role_desa" name="role_desa" options={fetchdataDesa} className={errors.role_desa && touched.role_desa ? 'p-invalid' : ''} optionLabel="label" optionValue="value" placeholder="Pilih salah satu" />
                </div>
              ...
              <div className="mb-3">
                ...
                <div className="row p-1 m-1">
                  <Field showClear filter as={Dropdown} id="role_kelompok" name="role_kelompok" options={fetchDataKelompok} className={errors.role_kelompok && touched.role_kelompok ? 'p-invalid' : ''} optionLabel="label" optionValue="value" placeholder="Pilih salah satu" />
                </div>
